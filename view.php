	...
	<body>
		...
		<div id="blog-section">
				<div class="container">
					...
					<div class="clear-fix">
					<?php
					$t=select("SELECT * FROM `car_for_rant` WHERE id='".$_REQUEST['id']."'");
				...
				<div class="container">
					<div class="clear-fix contact-address-content">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="left-side">
								<h2><?=ucwords($car_name)?></h2>
								<p style="text-align:justify"><?=$description?></p>
								
								<p style="text-align:justify;font-weight:bold;color:green">Price - <?=$price?> INR Per Hour</p>
								...
								<ul>
									...
									<li>
										...
										{
											?>
											<i class="fas fa-swimming-pool" aria-hidden="true"> Pool</i>&nbsp;&nbsp;
										...
										{
											?>
											<i class="fas fa-parking" aria-hidden="true"> Parking</i>
										...
										{
											?>
											<i class="fas fa-utensils-alt" aria-hidden="true">Restaurant</i>
										...
										{
											?>
											<i class="fas fa-utensils-alt" aria-hidden="true">A/c</i>
